    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(verbose_name='支付方式', default=3, choices=[(3, '支付宝支付'), (2, '微信支付'), (1, '货到付款'), (4, '网银支付')])),
                ('total_count', models.IntegerField(verbose_name='商品数量', default=1)),
                ('total_price', models.DecimalField(verbose_name='订单金额', max_digits=10, decimal_places=2)),
                ('transit_price', models.DecimalField(verbose_name='运费', max_digits=10, decimal_places=2)),
                ('order_status', models.SmallIntegerField(verbose_name='订单状态', default=1, choices=[(3, '待收货'), (5, '已完成'), (1, '待支付'), (4, '待评价'), (2, '待发货')])),
